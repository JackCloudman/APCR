...
class Ui(QtWidgets.QMainWindow):
    ...
    def upload(self):
        ...
        if type(self.send) == str:
            ...
            self.s.sendto(message.encode(),(self.h,int(self.p)))
            time.sleep(0.1)
    ...
    def sendFile(self,path):
        ...
        bytes_enviados = 0
        while (l):
            self.s.sendto(l,(self.h,int(self.p)))
            l = f.read(1024)
            bytes_enviados+=1024
        f.close()

    def path_list(self):
        self.s.sendto(json.dumps({"command":"getPathInfo","path":"."}).encode(),(self.h,int(self.p)))
    ...
    def downloads(self,s,name,filesize):
        ...
        myfile = s.recvfrom(1024)[0] #Descargamos el archivo
    ...
    def items_dwnl(self,item):
        ...
        self.s.sendto(json.dumps({"command":"descargar","path":".","nombres":[str(input_val)]}).encode(),(self.h,int(self.p)))
