// Ejemplo del maestro Axel
 import java.io.*;
 import java.net.*;
 import java.util.Vector;

public class MulticastClient2 extends Thread{
 	public static final String MCAST_ADDR  = "229.1.2.3"; //dir clase D valida, grupo al que nos vamos a unir
 	public static final int MCAST_PORT = 9999;//puerto multicast
